							...
							<div className="row align-items-end py-60">
								<div className="col-lg-5 ps-lg-5 text-lg-start text-center">
									<div className="position-relative mb-lg-0 mb-5">
										<img src="assets/imgs/image.png" alt="sameer" />
										<div className="position-absolute end-0 top-100 translate-middle-y icon-decorate">
											<img src="assets/imgs/home-page-2/hero-1/icon.svg" alt="sameer" />
										</div>
									</div>
								</div>
										...
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hey, I&apos;m Sameer Kumar Maurya</h1>
												</div>
											</div>
											
										</div>
										<h1 className="fs-50 my-3"> <span className="text-linear-4">{'{'}Full Stack{'}'}</span> Developer<span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2"><span className="text-dark">With expertise in cutting-edge technologies such as</span> <span className="text-secondary-2">NodeJS</span>, <span className="text-secondary-2">React</span>, <span className="text-secondary-2">NextJS</span>, and <span className="text-secondary-2">ExpressJS</span><span className="text-dark">... I deliver web solutions that are both innovative and robust.</span></p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
